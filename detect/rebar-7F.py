...
if __name__ == "__main__":
    ...
    videoIds = ["D06_20210115175538","D06_20210115183104"]
    videoPath = [f"/CV/WD8T1/06/{videoId}.mp4" for videoId in videoIds]
    videoId = videoIds[0]
    ...
    BimH = np.load("/home/gaobiaoli/dataset/base/7F_D06_1.npy")  # HtoBim
    ...
    cap = DeVibVideoCapture(
        videoPath=videoPath, initStep=10000,interval=100, mtx=mtx, dist=dist, calibrator=calibrator
    )
    ...
    while True:
        ...
        if ret:
            ...
            if len(img_batch)>0:
                ...
                torch.save(status_list,f"/home/gaobiaoli/dataset/result/{videoId}_i100_1.pth")
